  ...
  return (
    <div>
      ...
      <Modal
        ...
        overlayClassName="modal-overlay absolute top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center"
        className="modal-content absolute rounded w-11/12 md:max-w-md shadow-lg z-50 overflow-y-hidden px-6 py-4 bg-orange-200"
      >
        {/* Content */}
        <form>
          {/* Content__Title */}
